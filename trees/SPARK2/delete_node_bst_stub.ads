...
package Delete_Node_BST_Stub with SPARK_Mode => On is
   ...
   procedure Delete (T : in out Tree; V : Value) with Global => null;
   function Size (T : Tree) return Natural with Global => null;
   function Contains (T : Tree; V : Value) return Boolean with Global => null;
private
   type Value_Array is array (Slot) of Value; type Used_Array is array (Slot) of Boolean;
   type Tree is record Values : Value_Array; Used : Used_Array; Count : Index; end record;
