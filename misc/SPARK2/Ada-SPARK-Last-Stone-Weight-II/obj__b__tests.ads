...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#c50bf3a8#;
   ...
   u00004 : constant Version_32 := 16#0ab59d81#;
   pragma Export (C, u00004, "last_stone_weight_iiB");
   u00005 : constant Version_32 := 16#7d345f6e#;
   pragma Export (C, u00005, "last_stone_weight_iiS");
   ...
   --  system.assertions%s
   --  system.assertions%b
   --  last_stone_weight_ii%s
   --  last_stone_weight_ii%b
   --  tests%b
