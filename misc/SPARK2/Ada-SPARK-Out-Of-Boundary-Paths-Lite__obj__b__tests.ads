...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#604570e9#;
   ...
   u00004 : constant Version_32 := 16#9030543b#;
   pragma Export (C, u00004, "out_of_boundary_paths_liteB");
   u00005 : constant Version_32 := 16#c18d15de#;
   pragma Export (C, u00005, "out_of_boundary_paths_liteS");
   ...
   --  system.assertions%s
   --  system.assertions%b
   --  out_of_boundary_paths_lite%s
   --  out_of_boundary_paths_lite%b
   --  tests%b
