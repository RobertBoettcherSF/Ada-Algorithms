...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#371fa7a9#;
   ...
   u00004 : constant Version_32 := 16#068dae81#;
   pragma Export (C, u00004, "count_square_submatrices_with_all_onesB");
   u00005 : constant Version_32 := 16#f538949f#;
   pragma Export (C, u00005, "count_square_submatrices_with_all_onesS");
   ...
   --  system.assertions%s
   --  system.assertions%b
   --  count_square_submatrices_with_all_ones%s
   --  count_square_submatrices_with_all_ones%b
   --  tests%b
