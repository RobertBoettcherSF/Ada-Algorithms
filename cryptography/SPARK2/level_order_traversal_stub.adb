...
package body Level_Order_Traversal_Stub is
   ...
   function Level_Count (T : Tree; Root : Index; Level : Depth) return Natural is
      Nodes : Node_Stack := (others => 0);
      Levels : Depth_Stack := (others => 0);
      Top : Stack_Position;
      Count : Natural range 0 .. 15 := 0;
   begin
         ...
         if Top = 0 then
            ...
            begin
               ...
               if T.Used (N) then
                  ...
                  elsif D < Level and then D < Depth'Last then
...
end Level_Order_Traversal_Stub;
