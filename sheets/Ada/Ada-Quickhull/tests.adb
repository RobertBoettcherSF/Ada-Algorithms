--  Standalone test suite for Quickhull (main program).
...
begin
   Ada.Text_IO.Put_Line ("Quickhull tests");
   Ada.Text_IO.Put_Line ("===============");

   ------------------------------------------------------------------
   Section ("1. Near / Dist2 / Dist / Cross / Dot / Orient2D / DistLine");
   ------------------------------------------------------------------
   ...
   Check (Near (Distance_To_Line (P (0.0, 1.0), P (0.0, 0.0), P (1.0, 0.0)),
                R (1.0)),
          "Distance_To_Line unit height");
   Check (Near (Distance_To_Line (P (0.5, 0.0), P (0.0, 0.0), P (1.0, 0.0)),
                R (0.0)),
          "Distance_To_Line on segment ~0");
   Check (Near (Distance_To_Line (P (1.0, 1.0), P (0.0, 0.0), P (0.0, 0.0)),
                Dist (P (0.0, 0.0), P (1.0, 1.0))),
          "Distance_To_Line degenerate AB");
   ...
   ------------------------------------------------------------------
   Section ("6. Interior points ignored");
   ------------------------------------------------------------------
   declare
