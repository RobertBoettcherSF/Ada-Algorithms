--  Standalone test suite for Dinics_Algorithm (main program).

pragma Ada_2022;

with Ada.Text_IO; use Ada.Text_IO;
with Dinics_Algorithm; use Dinics_Algorithm;
...
begin
   ...
   ------------------------------------------------------------------
   Section ("6. Wikipedia seven-node network (Dinic)");
   ------------------------------------------------------------------
   ...
   ------------------------------------------------------------------
   --  Classic: s→a:1, s→b:1, a→b:1, a→t:1, b→t:1. Flow=2; Dinic may
