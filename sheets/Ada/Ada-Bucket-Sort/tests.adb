--  Standalone test suite for Bucket_Sort (main program).
...
begin
   ...
   ---------------------------------------------------------------------
   Section ("2. Small ranges / orderings");
   ---------------------------------------------------------------------
   ...
   --  Wide span with few buckets relative to range (bucket sort strength).
   Expect_Sorted (Random_Array (40, -10_000, 10_000), "wide span n=40");
   Expect_Sorted (Random_Array (80, 0, 1_000_000), "huge span n=80");
   ...
   Expect_Sorted ([Integer'First, Integer'Last], "Full Integer extremes");
   Expect_Sorted ([Integer'Last, Integer'First, 0], "extremes with zero");
