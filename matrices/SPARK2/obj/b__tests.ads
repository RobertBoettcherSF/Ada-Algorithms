...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#f291891a#;
   ...
   u00004 : constant Version_32 := 16#9166003a#;
   pragma Export (C, u00004, "num_matrix_block_sumB");
   u00005 : constant Version_32 := 16#2cef59c2#;
   pragma Export (C, u00005, "num_matrix_block_sumS");
   ...
   --  system.assertions%s
   --  system.assertions%b
   --  num_matrix_block_sum%s
   --  num_matrix_block_sum%b
   --  tests%b
